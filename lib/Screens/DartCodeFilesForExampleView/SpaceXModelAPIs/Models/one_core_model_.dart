...
//
//     final oneCoreModel = oneCoreModelFromJson(jsonString);
...
class OneCoreModel {
  ...
  factory OneCoreModel.fromRawJson(String str) => OneCoreModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory OneCoreModel.fromJson(Map<String, dynamic> json) => OneCoreModel(
