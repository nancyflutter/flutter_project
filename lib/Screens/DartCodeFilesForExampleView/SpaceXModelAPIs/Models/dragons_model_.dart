...
//
//     final dragonsModel = dragonsModelFromJson(jsonString);
...
class DragonsModel {
  ...
  factory DragonsModel.fromRawJson(String str) => DragonsModel.fromJson(json.decode(str));
